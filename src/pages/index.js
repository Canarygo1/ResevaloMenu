...
import '../bootlsander/assets/img/favicon.png';
import '../bootlsander/assets/img/apple-touch-icon.png';
import 'bootstrap/dist/css/bootstrap.min.css';
import '../bootlsander/assets/vendor/icofont/icofont.min.css';
import '../bootlsander/assets/vendor/boxicons/css/boxicons.min.css';
import '../bootlsander/assets/vendor/remixicon/remixicon.css';
import '../bootlsander/assets/vendor/venobox/venobox.css';
import '../bootlsander/assets/vendor/owl.carousel/assets/owl.carousel.min.css';
import 'aos/dist/aos.css'
import '../bootlsander/assets/css/style.css';
import AOS from 'aos';
                ...
                <header id="header" className="fixed-top d-flex align-items-center">
                    <div className="container d-flex align-items-center">
                        <div className="logo mr-auto">
                            <h1 className="text-light"><a href="index.html"><span>Resérvalo</span></a></h1>
                        </div>
                        ...
                        <div className="row">
                            <div className="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
                                <div data-aos="zoom-out">
                                    ...
                                    <h2>Resérvalo es la primera app móvil del mundo que permite reservas en diferentes tipos de negocios</h2>
                                    <div className="text-center text-lg-left">
                                        <a href="https://play.google.com/store/apps/details?id=capihair.cuthair" className="btn-get-started scrollto">Descarga la app</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="container-fluid">
                            <div className="row">
                                ...
                                <div className="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-left">
                                    ...
                                    <p>Ahorra tiempo gestionando las reservas de tu negocio mediante nuestra app. Asigna horarios y relájate mientras tus clientes disfutan de la sencillez de nuestra app a la hora de reservar citas.</p>
                                    <div className="icon-box" data-aos="zoom-in" data-aos-delay={100}>
                                        <div className="icon"><i className="bx bx-alarm" /></div>
                                        <h4 className="title">Ahorra tiempo</h4>
                                        <p className="description">Olvídate de las llamadas en medio de servicios con clientes.</p>
                                    </div>
                                    <div className="icon-box" data-aos="zoom-in" data-aos-delay={200}>
                                        <div className="icon"><i className="bx bx-gift" /></div>
                                        <h4 className="title">Da visibilidad a tu negocio</h4>
                                        <p className="description">Colocamos tu negocio estratégicamente en nuestra app para que obtengas el mayor número de reservas.</p>
                                    </div>
                                    <div className="icon-box" data-aos="zoom-in" data-aos-delay={300}>
                                        ...
                                        <p className="description">Nuestra app busca ser intuitiva para ti y tus clientes.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="row content">
                                ...
                                <div className="col-md-8 pt-4" data-aos="fade-up">
                                    ...
                                    <p className="font-italic">
                                        Contamos con una de las BarberShop de más categoría y famosa de Tenerife como contribuidor principal. Conocemos
                            ...
                            <div className="row content">
                                ...
                                <div className="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
                                    ...
                                    <ul>
                                        <li><i className="icofont-check" /> Ahorro de tiempo.</li>
                                        <li><i className="icofont-check" /> Control de las reservas.</li>
                                        <li><i className="icofont-check" /> Asignación de número de mesas disponibles.</li>
                            ...
                            <div className="row content">
                                ...
                                <div className="col-md-8 pt-5" data-aos="fade-up">
                                    ...
                                    <ul>
                                        ...
                                        <li><i className="icofont-check" /> Creación de entradas mediante Códigos QR.</li>
                            ...
                            <div className="faq-list">
                                <ul>
                                    <li data-aos="fade-up">
                                        ...
                                        ¿En cuánto tiempo podéis incluir mi negocio en Resérvalo? <i className="bx bx-chevron-down icon-show" /><i className="bx bx-chevron-up icon-close" /></a>
                                        <div id="faq-list-1" className="collapse show" data-parent=".faq-list">
                                            <p>
                                                Los restaurantes y peluquerías son integrados en una media de 72 horas, hacemos el máximo esfuerzo por reducir estos tiempos.
                                                Las discotecas tienen una integración distinta debido a la gestión de entradas, etc. Si quieres saber el tiempo aproximado que tardaremos con tu negocio no dudes en llamarnos. ¡Los tiempos de Resérvalo te sorprenderán!
                                            </p>
                                        </div>
                                    </li>
                                    <li data-aos="fade-up" data-aos-delay={100}>
                                        <i className="bx bx-help-circle icon-help" /> <a data-toggle="collapse" href="#faq-list-2" className="collapsed">¿Cobráis comisiones por cita/entrada? <i className="bx bx-chevron-down icon-show" /><i className="bx bx-chevron-up icon-close" /></a>
                                        <div id="faq-list-2" className="collapse" data-parent=".faq-list">
                                            <p>
                                                Actualmente no cobramos comisiones por citas. Por entradas solo se cobra el coste de la pasarela de pago (exactamente la establecida por nuestro proveedor).
                                            </p>
                                        </div>
                                    </li>
                                    <li data-aos="fade-up" data-aos-delay={200}>
                                        <i className="bx bx-help-circle icon-help" /> <a data-toggle="collapse" href="#faq-list-3" className="collapsed">¿En qué plataformas está disponible Resérvalo? <i className="bx bx-chevron-down icon-show" /><i className="bx bx-chevron-up icon-close" /></a>
                                        <div id="faq-list-3" className="collapse" data-parent=".faq-list">
                                            <p>
                                                Resérvalo está disponible en las principales plataformas móviles: Android e IOS. Abarcando así toda la cuota de mercado móvil.
                                            </p>
                                        </div>
                                    </li>
                                    <li data-aos="fade-up" data-aos-delay={200}>
                                        <i className="bx bx-help-circle icon-help" /> <a data-toggle="collapse" href="#faq-list-3" className="collapsed">¿Contáis con aplicación para empleados y jefes? <i className="bx bx-chevron-down icon-show" /><i className="bx bx-chevron-up icon-close" /></a>
                                        <div id="faq-list-3" className="collapse" data-parent=".faq-list">
                                            <p>
                                                El jefe y el empleado tienen su propia aplicación desde la que pueden asignar horarios, consultarlos y cancelar citas.
                                            </p>
                                        </div>
                                    </li>
                                </ul>
                        ...
                        <div className="container">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-8 mt-5 mt-lg-0" data-aos="fade-left" data-aos-delay={200}>
                                    <form action="https://formspree.io/xbjzgjnw" method="POST" className="php-email-form">
                                        <div className="form-row">
                                            ...
                                            <div className="col-md-6 form-group">
                                                <input type="email" className="form-control" name="_replyto" id="email" placeholder="Email" data-rule="email" data-msg="Please enter a valid email" />
                                                <div className="validate" />
                                            </div>
                                        </div>
                                        ...
                                        <div className="form-group">
                                            <textarea className="form-control" name="message" rows={5} data-rule="required" data-msg="Please write something for us" placeholder="Escribe tu consulta, estaremos encantados de atenderla" defaultValue={""} />
                                            <div className="validate" />
                                        </div>
                                        <div className="mb-3">
                                            <div className="loading">Tu mensaje a sido enviado en breve nos pondremos en contacto contigo</div>
